...
class TrainerMod(object):
    """This class is the abstract class for the mlagents.trainers"""

    def __init__(self, sess, brain_name, trainer_parameters, training, run_id, summary_event):
        """
        Responsible for collecting experiences and training a neural network model.
        :param sess: Tensorflow session.
        :param trainer_parameters: The parameters for the trainer (dictionary).
        :param training: Whether the trainer is set for training.
        :param summary_event: Dispatches summary / stats data (Hypertuner).
        """
        self.sess = sess
        ...
        if global_step % self.trainer_parameters['summary_freq'] == 0 and global_step != 0:
            ...
            if len(self.stats['cumulative_reward']) > 0:
                ...
                logger.info("#{} {}: {}: Step: {}. Mean Reward: {:0.3f}. Std of Reward: {:0.3f}. {}"
                            .format(self.summary_event.trainer_num, self.run_id, self.brain_name,
                ...
                logger.info("#{} {}: {}: Step: {}. No episode was completed since last summary. {}"
                            .format(self.summary_event.trainer_num, self.run_id, self.brain_name, 
                                    self.get_step, is_training))
            # Hypertuner: Collect and dispatch event_data.
            event_data = {}
            event_data['step'] = int(self.get_step)
            event_data['brain_name'] = self.brain_name
            summary = tf.Summary()
