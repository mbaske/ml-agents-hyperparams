...
from trainer_mod import TrainerMod

logger = logging.getLogger("mlagents.envs")


class BehavioralCloningTrainerMod(TrainerMod):
    """The ImitationTrainer is an implementation of the imitation learning."""

    def __init__(self, sess, brain, trainer_parameters, training, seed, run_id, summary_event):
        """
        Responsible for collecting experiences and training PPO model.
        :param sess: Tensorflow session.
        :param  trainer_parameters: The parameters for the trainer (dictionary).
        :param training: Whether the trainer is set for training.
        :param summary_event: Dispatches summary data (Hypertuner).
        """
        super(BehavioralCloningTrainerMod, self).__init__(sess, brain, trainer_parameters, training,
                                                       run_id, summary_event)
