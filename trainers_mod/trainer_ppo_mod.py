...
class PPOTrainerMod(TrainerMod):
    """The PPOTrainer is an implementation of the PPO algorithm."""

    def __init__(self, sess, brain, reward_buff_cap, trainer_parameters, training, seed,
        ...
        """
        super(PPOTrainerMod, self).__init__(sess, brain.brain_name, trainer_parameters, training,
                                         run_id, summary_event)
